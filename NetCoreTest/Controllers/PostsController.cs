...
namespace NetCoreTest.Controllers
{
    public class PostsController : Controller
    {
        ...
        public PostsController(CoreTextDatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PostId,Author,Title,Content,PublishTimeStamp,GuestBookId")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
